...
public class MovieExamples
{
	...
	Movie swampThing = new Movie("RiffTrax Live: The Return of Swamp Thing", 1830, 118, true);
	...
	public void instructorTestShowSummary_DifferentInstances() {
		...
		Movie swampThing2 = new Movie("RiffTrax Live: The Return of Swamp Thing", 1830, 118, true);
